...
public class Asset {
     ...
     *
     * @param quantity The number of units of the asset.
     */
     ...
     *
     * @param purchasePrice The price per unit of the asset when it was purchased.
     */
    ...
    /**
     * Calculates the current total value of the asset based on the quantity and the current market price.
     *
     * @return The total current value of the asset (quantity × current market price).
     */
